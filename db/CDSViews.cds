...
context CDSViews {
    ...
    define view ![POWorkList] as
        select from transaction.purchaseorder {
            ...
            key Items.PO_ITEM_POS                 as ![ItemPosition],
                ...
                PARTNER_GUID.COMPANY_NAME         as ![CompamyName],
    ...
    define view ![ItemView] as
        select from transaction.poitems {
            ...
            PRODUCT_GUID.PRODUCT_ID          as ![Product],
            PRODUCT_GUID.DESCRIPTION         as ![Description],

        };

    // Mixin View on top of ItemView
    ...
    // Aggregation View on top of ProductView
